...
def search_show(request, template_name):
    ...
    # 查询条件
    maturity_search_dict = search_dict
    independence_search_dict = search_dict
    business_search_dict = search_dict
    technology_search_dict = search_dict
    maturity_independence_search_dict = search_dict
    business_technology_search_dict = search_dict
    # 成熟度
    for i in maturity:
        maturity_search_dict["maturity__first_class"] = i.first_class
    ...
    # 自主度
    for i in independence:
        independence_search_dict["independence__first_class"] = i.first_class
    ...
    # 业务领域
    for i in business:
        business_search_dict["business__first_class"] = i.first_class
    ...
    # 技术形态
    for i in technology:
        technology_search_dict["technology__first_class"] = i.first_class
