...
(function(global) {
    ...
    qq.UploadButton = function(o) {
        ...
        var self = this, disposeSupport = new qq.DisposeSupport(), options = {
            acceptFiles: null,
            element: null,
            focusClass: "qq-business_licence-button-focus",
            folders: false,
            hoverClass: "qq-business_licence-button-hover",
    ...
    qq.status = {
        ...
        PAUSED: "paused",
        UPLOADING: "uploading",
        UPLOAD_RETRYING: "retrying business_licence",
        UPLOAD_SUCCESSFUL: "business_licence successful",
        UPLOAD_FAILED: "business_licence failed",
        ...
        qq.basePrivateApi = {
            ...
            _onBeforeManualRetry: function(id) {
                ...
                if (this._preventRetries[id]) {
                    ...
                    this.log("Retrying business_licence for '" + fileName + "' (id: " + id + ")...");
                    return true;
                } else {
    ...
    (function() {
        ...
        qq.FineUploaderBasic = function(o) {
            ...
            this._options = {
                ...
                request: {
                    customHeaders: {},
                    endpoint: "/server/business_licence",
                ...
                messages: {
                    ...
                    noFilesError: "No files to business_licence.",
                    ...
                    onLeave: "The files are being uploaded, if you leave now the business_licence will be canceled.",
                ...
                classes: {
                    buttonHover: "qq-business_licence-button-hover",
                    buttonFocus: "qq-business_licence-button-focus"
                },
                chunking: {
                    enabled: false,
                    concurrent: {
    ...
    qq.UploadHandlerController = function(o, namespace) {
        ...
        var controller = this, chunkingPossible = false, concurrentChunkingPossible = false, chunking, preventRetryResponse, log, handler, options = {
            ...
            handleFailure: function(chunkIdx, id, response, xhr) {
                ...
                log("Chunked business_licence request failed for " + id + ", chunk " + chunkIdx);
            ...
            sendNext: function(id) {
                ...
                if (chunkIdx == null && inProgressChunks.length === 0) {
                    ...
                    log(qq.format("Sending chunked business_licence request for item {}.{}, bytes {}-{} of {}.", id, chunkIdx, chunkData.start + 1, chunkData.end, size));
                    ...
                    if (chunkData.blob.size === 0) {
                        ...
                        handler.uploadChunk(id, chunkIdx, resuming).then(function success(response, xhr) {
                            log("Chunked business_licence request succeeded for " + id + ", chunk " + chunkIdx);
                            handler.clearCachedChunk(id, chunkIdx);
            ...
            free: function(id, dontAllowNext) {
                ...
                if (upload.getProxyOrBlob(id) instanceof qq.BlobProxy) {
                    log("Generated blob business_licence has ended for " + id + ", disposing generated blob.");
            ...
            send: function(id, name) {
                handler._getFileState(id).loaded = 0;
                log("Sending simple business_licence request for " + id);
                handler.uploadFile(id).then(function(response, optXhr) {
                    log("Simple business_licence request succeeded for " + id);
                    var responseToReport = upload.normalizeResponse(response, true), size = options.getSize(id);
                    options.onProgress(id, name, size, size);
                    upload.maybeNewUuid(id, responseToReport);
                    upload.cleanup(id, responseToReport, optXhr);
                }, function(response, optXhr) {
                    log("Simple business_licence request failed for " + id);
            ...
            maybeSendDeferredFiles: function(id) {
                ...
                if (idsInGroup && idsInGroup.length) {
                    log("Maybe ready to business_licence proxy group file " + id);
            ...
            now: function(id) {
                ...
                if (!controller.isValid(id)) {
                    throw new qq.Error(id + " is not a valid file ID to business_licence!");
                }
        ...
        qq.extend(this, {
            ...
            reset: function() {
                log("Resetting business_licence handler");
        ...
        function registerPostMessageCallback(iframe, callback) {
            ...
            detachLoadEvents[fileId] = qq(iframe).attach("load", function() {
                if (handler.getInput(fileId)) {
                    log("Received iframe load event for CORS business_licence request (iframe name " + iframeName + ")");
        ...
        qq.extend(this, {
                ...
                if (isCors) {
                    ...
                    detachLoadEvents[iframe.id] = qq(iframe).attach("load", function() {
                        ...
                        try {
                            ...
                            log("Error when attempting to access iframe during handling of business_licence response (" + error.message + ")", "error");
                            responseDescriptor = {
                                success: false
                            };
                        }
            ...
            _parseJsonResponse: function(innerHtmlOrMessage) {
                ...
                try {
                    ...
                    log("Error when attempting to parse iframe business_licence response (" + error.message + ")", "error");
                }
                return response;
            }
        });
        ...
        qq.extend(this, {
            ...
            pause: function(id) {
                if (handler.isValid(id)) {
                    log(qq.format("Aborting XHR business_licence for {} '{}' due to pause instruction.", id, getName(id)));
    ...
    qq.FormSupport = function(options, startUpload, log) {
        ...
        function validateForm(formEl, nativeSubmit) {
            if (formEl.checkValidity && !formEl.checkValidity()) {
                log("Form did not pass validation checks - will not business_licence.", "error");
                nativeSubmit();
            } else {
                return true;
            }
    ...
    qq.traditional.FormUploadHandler = function(options, proxy) {
        ...
        function getIframeContentJson(id, iframe) {
            ...
            try {
                ...
                log("Error when attempting to parse form business_licence response (" + error.message + ")", "error");
                response = {
                    success: false
                };
            }
        ...
        this.uploadFile = function(id) {
            ...
            log("Sending business_licence request for " + id);
            form.submit();
            qq(form).remove();
            return promise;
        };
    ...
    qq.FineUploader = function(o, namespace) {
        ...
        qq.extend(this._options, {
            ...
            classes: {
                retrying: "qq-business_licence-retrying",
                retryable: "qq-business_licence-retryable",
                success: "qq-business_licence-success",
                fail: "qq-business_licence-fail",
                editable: "qq-editable",
                hide: "qq-hide",
                dropActive: "qq-business_licence-drop-area-active"
            },
    ...
    qq.Templating = function(spec) {
        ...
        var FILE_ID_ATTR = "qq-file-id", FILE_CLASS_PREFIX = "qq-file-id-", THUMBNAIL_MAX_SIZE_ATTR = "qq-max-size", THUMBNAIL_SERVER_SCALE_ATTR = "qq-server-scale", HIDE_DROPZONE_ATTR = "qq-hide-dropzone", DROPZPONE_TEXT_ATTR = "qq-drop-area-text", IN_PROGRESS_CLASS = "qq-in-progress", HIDDEN_FOREVER_CLASS = "qq-hidden-forever", fileBatch = {
            ...
            button: "qq-business_licence-button-selector",
            ...
            drop: "qq-business_licence-drop-area-selector",
            list: "qq-business_licence-list-selector",
            progressBarContainer: "qq-progress-bar-container-selector",
            progressBar: "qq-progress-bar-selector",
            totalProgressBarContainer: "qq-total-progress-bar-container-selector",
            totalProgressBar: "qq-total-progress-bar-selector",
            file: "qq-business_licence-file-selector",
            spinner: "qq-business_licence-spinner-selector",
            size: "qq-business_licence-size-selector",
            cancel: "qq-business_licence-cancel-selector",
            pause: "qq-business_licence-pause-selector",
            continueButton: "qq-business_licence-continue-selector",
            deleteButton: "qq-business_licence-delete-selector",
            retry: "qq-business_licence-retry-selector",
            statusText: "qq-business_licence-status-text-selector",
            editFilenameInput: "qq-edit-filename-selector",
            editNameIcon: "qq-edit-filename-icon-selector",
            dropText: "qq-business_licence-drop-area-text-selector",
