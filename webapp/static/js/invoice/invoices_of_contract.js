    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                ajax: {
                    url: "/invoice/invoices_of_contract/data/" + $("#contract").val() + "/"
                },
                    ...
                    {"mData": "null", "sTitle": "操作", "sClass": "center",
                        "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                            ...
                            modify.on('click', function () {
                                var id = oData["id"];
                                location.href = "/invoice/invoice_application/modify/" + id + "/";
                            });
        ...
        tableWrapper.on('click', '.filter-submit', function (e) {
            e.preventDefault();
            //only set no reaload
            grid.setUrl("/invoice/invoices_of_contract/data/" + $("#contract").val()) + "/";
            grid.submitFilter();
        });
