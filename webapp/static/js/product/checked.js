    ...
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: {
                ...
                ajax: {
                    url: "/product_management/checked/data/"
                },
                ...
                "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空,bVisible是否可见
                    ...
                    {"mData": "pass_time", "sTitle": "审核时间"},
                    {"mData": "status_name", "sTitle": "审核结果"},
                    {"mData": "reason", "sTitle": "原因"},
        ...
        tableWrapper.on('click', '.filter-submit', function (e) {
            e.preventDefault();
            grid.setUrl("/product_management/checked/data/");
            grid.submitFilter();
        });
